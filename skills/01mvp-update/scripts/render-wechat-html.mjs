...
function renderHtml({ title, body, date }) {
  return `<!-- Generated by 01mvp-update. Paste the inner HTML into the WeChat editor. -->
<section style="margin:0;padding:24px 0;background-color:#ffffff;">
  <section style="margin:0 auto;padding:0;max-width:677px;box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif;">
    ...
    <section style="margin:0 0 18px;padding:16px 18px;background-color:#000000;box-sizing:border-box;">
      <p style="margin:0;font-size:18px;line-height:1.65;color:#ffffff;font-weight:700;">
        这是一篇 01MVP 知识库更新。只保留读者能用上的变化，不写内部工程流水账。
      </p>
    </section>
...
${renderBody(body)}
    ...
    <section style="margin:28px 0 28px;padding:18px;border:2px solid #000000;background-color:#ffffff;box-sizing:border-box;">
      ...
      <p style="margin:0;font-size:16px;line-height:1.65;color:#111111;">
        如果你也在用 AI 做自己的小产品，可以从 01MVP 实战手册开始：<a href="https://01mvp.com/docs/guide" style="color:#000000;text-decoration:underline;text-underline-offset:3px;">01mvp.com/docs/guide</a>
      </p>
    </section>
