...
- **Maker Jackie** 是人、信任和内容源头。读者先认识 Jackie，再在合适的时候购买 01MVP。
- **01MVP** 是产品、课程和付费转化入口，用来承接想系统学习 AI 产品实战的读者。
- 标准关系句：`01MVP 是 Maker Jackie 做的 AI 产品实战教程。`
- 不要把 `makerjackie.com / 01mvp.com` 当成固定尾巴并列出现。每篇内容只保留一个主要动作：关注 Maker Jackie，或者去 01mvp.com。
- AI 教程、产品实战、独立开发复盘主推 **01MVP**，轻带 Maker Jackie。
- 个人成长、思考、自媒体、生活记录主推 **Maker Jackie**，轻带 01MVP。
...
如果文章需要明确转化，在固定尾部前按文章意图二选一，不要两个都放：

```md
**关于 01MVP**
01MVP 是 Maker Jackie 整理的 AI 产品实战手册，记录如何从一个想法出发，借助 AI 做出可上线的产品，并找到第一个真实用户。

如果你正在用 AI 做产品，欢迎来 01mvp.com 从第一章开始。
```

```md
**关于 Maker Jackie**
我是 Jackie，独立开发者，01MVP 作者。这里记录 AI 实践、独立开发、个人成长和一些阶段性的答案。

系统化的 AI 产品实战教程，我放在 01mvp.com。
```
