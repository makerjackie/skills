...
name: mj-writer
description: |
  Maker Jackie 的内容写作 skill。适用于公众号文章、AI 教程、01MVP 实战指南、Twitter 长推等。当用户需要写文章、写教程、根据素材产出内容时使用。触发词：写文章、写教程、帮我写、续写、扩写、公众号、教程、指南、按我的风格写。也适用于用户提供素材（PDF、链接、语音转文字）说"帮我写"的场景。
---
